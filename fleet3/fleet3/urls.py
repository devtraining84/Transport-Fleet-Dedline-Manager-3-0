...
from vehicles.views import AddAdrVehView, AddBtView, AddTachoView, AddUkView, AddVehicleView, DeleteVehicleView, SearchVehicleView, BridgeEditView, EditVehicleView, BridgeDelView, DeleteVehicleView
