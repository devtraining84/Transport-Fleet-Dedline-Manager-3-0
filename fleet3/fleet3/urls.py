...
from vehicles.views import AddAdrVehView, AddBtView, AddTachoView, AddUdtView, AddUkView, AddVehicleView, DeleteVehicleView, SearchVehicleView, BridgeEditView, EditVehicleView, BridgeDelView, DeleteVehicleView
